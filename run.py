...
def validate_data(values):
    ...
    Raises value error if strings cant be convderted into int, or  there
    are noy exactly 6 values
    """
    try:
...
def update_surplus_worksheet(data):
    ...
    upsate suprlus worksheet, add new row with surplus data
...
def update_worksheet(data, worksheet):
    """
    upsate worksheet, receives dat and updates worksheet
    """   
...
def caluclate_surplus_data(sales_row):   
    ...
    The surplus is defined as the sales figures subtract from stock
...
def calculate_stock_data(data):
    """
    Calculate the average stock for each new item adding 10%
    """
